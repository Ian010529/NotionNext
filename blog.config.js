...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ian', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'MSc student at Durham University studying Scientific Computing and Data Analysis', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.codingian.com/', // 网站地址
